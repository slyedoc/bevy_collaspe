...
impl Plugin for AsciiPlugin {
    fn build(&self, app: &mut App) {
        app
            ...
            .add_system_set(SystemSet::on_exit(GameState::AssetLoading).with_system(load_ascii))
...
fn load_ascii(
    ...
    mut ascii_asset: Res<AsciiAssets>,
) {
    let atlas = TextureAtlas::from_grid_with_padding(ascii_asset.ascii.clone(), Vec2::splat(9.0), 16, 16, Vec2::splat(2.0));
